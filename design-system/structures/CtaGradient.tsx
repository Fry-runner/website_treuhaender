  ...
  <section className="ds-cta-grad" style={{
    ...
    <Container style={{ maxWidth: "min(var(--ds-container), 760px)" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.1rem" }}>
        <h2 style={{ fontFamily: "var(--ds-font-heading)", fontWeight: "var(--ds-headline-weight)" as unknown as number, fontSize: "2.2rem", letterSpacing: "var(--ds-headline-tracking)", color: "var(--ds-primary-fg)", margin: 0 }}>
          {content.heading}
        </h2>
        ...
        <button style={{
          marginTop: "0.4rem", fontFamily: "var(--ds-font-mono)", fontSize: "0.8rem", textTransform: "uppercase",
          letterSpacing: "0.08em", fontWeight: 600, padding: "0.9rem 1.8rem", borderRadius: "var(--ds-radius-pill)",
