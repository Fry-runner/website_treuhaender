    ...
    <Container>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "2rem", flexWrap: "wrap" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem", maxWidth: "48ch" }}>
          <h2 style={{ fontFamily: "var(--ds-font-heading)", fontWeight: "var(--ds-headline-weight)" as unknown as number, fontSize: "1.9rem", letterSpacing: "var(--ds-headline-tracking)", color: "var(--ds-text)", margin: 0 }}>{content.heading}</h2>
